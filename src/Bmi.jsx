              ...
              <li className="col-span-12 lg:col-start-4 lg:col-end-10 xl:col-start-5 xl:col-end-9 flex flex-col items-center gap-y-5">
                ...
                <div className="w-full flex">
                  <div className="w-full flex flex-col items-center">
                    ...
                    <p className="font-semibold mt-2 text-[11px] sm:text-md">UNDERWEIGHT</p>
                    <p className="font-semibold mt-2 text-[11px] sm:text-md">{"<"} 18,5</p>
                  </div>
                  <div className="w-auto sm:w-full flex flex-col items-center">
                    <div className="w-[80px] sm:w-full h-2 bg-green-500"></div>
                    <p className="font-semibold mt-2 text-[11px] sm:text-md">NORMAL</p>
                    <p className="font-semibold mt-2 text-[11px] sm:text-md">18,5 - 25</p>
                  </div>
                  <div className="w-full flex flex-col items-center">
                    <div className="w-full h-2 bg-orange-500"></div>
                    <p className="font-semibold mt-2 text-[11px] sm:text-md">OVERWEIGHT</p>
                    <p className="font-semibold mt-2 text-[11px] sm:text-md">25 - 30</p>
                  </div>
                  <div className="w-auto sm:w-full flex flex-col items-center">
                    <div className="w-[70px] sm:w-full h-2 bg-red-500"></div>
                    <p className="font-semibold mt-2 text-[11px] sm:text-md">OBESE</p>
                    <p className="font-semibold mt-2 text-[11px] sm:text-md">{">"} 30</p>
                  </div>
                </div>
              </li>
            </ul>

  ...
  return (
    <div className="flex flex-col h-screen gap-y-2">
      <div className="flex p-5">
        <Link
          className="flex items-center gap-x-1 bg-yellow-600 px-5 py-2 rounded-3xl text-white"
          to="/"
        >
          ...
          {cards.map((card, index) => (
            ...
            >
              <div className="card-inner relative w-full h-32 sm:h-40 md:h-48 lg:h-56">
                <div className="card-front absolute w-full h-full flex items-center justify-center text-xl font-bold text-white bg-yellow-500 rounded-lg">
                  ?
                </div>
                <img
                  src={card.tebakan}
                  className="card-back object-cover absolute w-full h-full flex items-center justify-center text-xl font-bold border-4 border-yellow-500 rounded-lg transform rotate-y-180"
                />
              </div>
            </div>
          ))}
      ...
      {showInstructions && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 p-4">
          <div className="bg-white p-6 sm:p-8 md:p-10 lg:p-12 rounded-lg shadow-lg max-w-md w-full text-center space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold mb-2 text-yellow-600">
              Ketentuan Permainan
            </h2>
            ...
            <button
              ...
              className="bg-yellow-600 hover:bg-yellow-700 transition-colors text-white px-4 py-2 rounded-lg text-sm sm:text-base"
            >
              Mulai Bermain
            </button>
          </div>
